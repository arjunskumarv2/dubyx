              ...
              Container(
                ...
                child: Row(children: [
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4), decoration: BoxDecoration(color: Colors.white20, borderRadius: BorderRadius.circular(20)),
                      child: Text(user?.area ?? user?.role ?? '', style: const TextStyle(color: Colors.white, fontSize: 11))),
                  ])),
                  Container(width: 56, height: 56, decoration: BoxDecoration(color: Colors.white20, shape: BoxShape.circle),
