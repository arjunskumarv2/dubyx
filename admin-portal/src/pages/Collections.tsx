        ...
        <div className="card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">SAR {(todayData?.total || 0).toFixed(0)}</p>
        ...
        <div className="card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">SAR {pending.reduce((s: number, p: any) => s + p.balance, 0).toFixed(0)}</p>
        ...
        <div className="card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">SAR {allCollections.reduce((s: number, c: any) => s + c.amount, 0).toFixed(0)}</p>
              ...
              <div key={inv.id} className="px-5 py-3 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-[#8D1B3D]">SAR {inv.balance?.toFixed(2)}</p>
            ...
            {allCollections.slice(0, 20).map((c: any) => (
              <div key={c.id} className="px-5 py-3 hover:bg-gray-50">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-green-600">SAR {c.amount?.toFixed(2)}</p>
